            ...
            <thead>
                        ...
                        <div class="row listar">
                            ...
                            <div class="col">
                                ...
                                <a href="{{ route('agenda.index') }}">
                                    <button class="btn btn-secondary" type="button"><img src="{{asset('img/rotate-cw.svg')}}" alt="reload" class="reload"></button>
                                </a>
                            </div>
                        </div>   
                    </form>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $compromissos->status->nome_status }}</td>
                    ...
                    <td><button type="button" class="btn btn-danger"> <a href="{{ route('agenda.excluir', $compromissos->id) }}" class="nav-link cadastro" id="editar">Excluir</a></button></td>
                </tr>
                @endforeach
              </tbody>
        </table>
